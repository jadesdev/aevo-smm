...
class DealController extends Controller
{
    ...
    function make_offer(Request $request){
        // validate request
        $request->validate([
    ...
    function offer_payment(Request $request, $id){
        $offer = ListingOffer::where('user_id', Auth::id())->whereId($id)->first();
        if(!$offer){
            return back()->withError('You do not have permission to modify this offer');
        }
    ...
    function seller_offer_comment($id, Request $request){
    ...
    function buyer_offer_comment($id, Request $request){
        $trx = ListTrx::where('buyer_id', Auth::id())->whereId($id)->first();
        if(!$trx){
            return back()->withError('You do not have permission to modify this offer');
        }
    ...
    // deal confirmation
    function buyer_offer_confirmation($id, Request $request){
        $trx = ListTrx::where('buyer_id', Auth::id())->whereId($id)->first();
        if(!$trx){
    ...
    function seller_offer_confirmation($id, Request $request){
        $trx = ListTrx::where('seller_id', Auth::id())->whereId($id)->first();
        if(!$trx){
            return back()->withError('You do not have permission to confirm this deal');
        }
    ...
    function complete_monnify_payment($details, $response = null){
        // get trx
