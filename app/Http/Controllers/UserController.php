...
class UserController extends Controller
{
    ...
    public function complete_autodeposit($details, $response = null)
    {
    ...
    public function manual_deposit(Request $request)
    {
    ...
    public function point_withdraw(Request $request)
    {
        $request->validate([
            'withdraw_type' => 'string|required',
