...
{
    //
    function initCronjob(Request $request){
    ...
    function provider_service_update(Request $request){
    ...
    function send_scheduled_email(Request $request){
