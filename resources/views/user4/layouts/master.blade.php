...
<head>
    ...
    <link href="{{ static_asset('theme4/css/vendors.css') }}" rel="stylesheet">
    <link href="{{ static_asset('theme4/css/style.css') }}" rel="stylesheet">
...
<body >
    <div class="my--wrapper">
        @include('user4.layouts.sidebar')

        <div class="container-fluid my--container">
            @include('user4.layouts.header')
    ...
    {{-- Scripts --}}
    <script src="{{ static_asset('theme4/js/vendors.js') }}"></script>
    <script src="{{ static_asset('theme4/js/main.js') }}"></script>
