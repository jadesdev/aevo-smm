...
<div class="row">
    <div class="col-md-6 col-lg-4">
        <div class="d-card">
            <div class="card-header">
                <h3 class="mb-0 h6 ">Maintenance</h3>
            </div>
    ...
    <div class="col-md-6 col-lg-4" style="display:none;">
        <div class="d-card">
            <div class="card-header">
                <h3 class="mb-0 h6 ">Bills Payment</h3>
            </div>
            <div class="d-card-body">
                <label class="jdv-switch jdv-switch-success mb-0">
                    <input type="checkbox" onchange="updateSystem(this, 'bills_payment')" @if(sys_setting('bills_payment') == 1) checked @endif >
                    <span class="slider round"></span>
                </label>
            </div>
        </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="d-card">
            <div class="card-header">
                <h3 class="mb-0 h6 ">Theme Settings</h3>
            </div>
            <div class="d-card-body">
                <form action="{{route('admin.setting.store_settings')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select name="homepage_theme" required class="form-control">
                            ...
                            <option value="theme2 hidden" @if (sys_setting('homepage_theme') == "theme2" )selected @endif>Theme 2</option>
                            <option value="theme3 hidden" @if (sys_setting('homepage_theme') == "theme3" )selected @endif>Theme 3</option>
                        </select>
                    </div>
