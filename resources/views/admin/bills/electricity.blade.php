...
<div class="d-card">
    <div class="card-header">
        ...
        <a class="btn btn-primary btn-sm" href="#" data-toggle="modal" data-target="#createCompany"><i class="fas fa-plus"></i> New Company</a>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="drop">
                            ...
                            @if($item->status == 1)
                            <a class="btn btn-warning btn-sm" href="{{route('admin.bills.power.status' ,[$item->id, 0])}}">Disable</a> @else
                            <a class="btn btn-success btn-sm" href="{{route('admin.bills.power.status' ,[$item->id, 1])}}">Enable</a>
                            @endif
                            <a class="btn btn-danger btn-sm" href="{{route('admin.bills.power.delete' ,[$item->id])}}" title="Delete"><i class="fa fa-trash"></i></a>
                        </div>
                    </td>
                </tr>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-body">
            <form action="{{route('admin.bills.power.create')}}" enctype="multipart/form-data" method="post">
                @csrf
                <div class="form-group">
                    <label class="form-label">Electricity Name</label>
