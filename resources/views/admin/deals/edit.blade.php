...
<div class="d-card">
    ...
    <div class="d-card-body">
        <form action="" method="post" class="row" enctype="multipart/form-data">
            ...
            <div class="form-group col-md-6">
                <label class="form-label">Enter Price ({{get_setting('currency')}})</label>
            ...
            <div class="form-group col-md-6">
                ...
                <select name="status" id="" class="form-control">
                    <option @if($listing->status == 1) selected @endif value="1">published</option>
                    <option @if($listing->status == 2) selected @endif value="2">pending</option>
                    <option @if($listing->status == 0) selected @endif value="2">draft</option>
                </select>
            </div>
            <div class="form-group col-md-6">
