                    ...
                    <div class="ref-item">
                        <div class="row">
                            ...
                            <div class="col-12 d-flex align-self-center form-group">
                                ...
                                <button class="btn btn-primary ms-2" onclick="copyFunction('{{route('signup')}}?ref={{Auth::user()->username}}')">Copy</button>
                            </div>
                        </div>
                    </div>
                    <div class="ref-item">
                        <div class="row">
                            ...
                            <div class="col-12 d-flex align-self-center form-group">
                                ...
                                <button class="btn btn-primary ms-2" onclick="copyFunction('{{Auth::user()->username}}')">Copy</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="ref-item">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-12 hlight-second align-self-center">
                                {{format_price(sys_setting('min_withdraw'))}}
                            </div>
                        </div>
                    </div>
